...
async function PUT(request, { params }) {
    try {
        ...
        const updatedDoc = await db.collection(COLLECTION_NAME).findOne({
            _id: objectId
        });
        ...
        if (updatedDoc.dealerId) {
            try {
                const dealer = await db.collection('dealers').findOne({
                    _id: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongodb__$5b$external$5d$__$28$mongodb$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongodb$29$__["ObjectId"](updatedDoc.dealerId)
                });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9e452385._.js.map